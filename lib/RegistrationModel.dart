...
class RegistrationModel extends Model {
  ...
  String _pic, _nom="1", _prenom="2", _birth="1992-06", _profexp="2015-06", _whatsappnumber="1992",
    _company, _period1, _period2, _poscategory, _jobtags,
    _workdescription, _jobindustry, _jobachievement,
    _school, _degree, _major, _timeframe, schoolachievement,
    _advantage='''
...
5. ...
                        ''', 
    _expectedstatus, _expectedjob, _expectedcareer,
    _expectedtown, _expectedmoney,
    _projectname, _projectrole, _projectduration1, _projectduration2,
    _projectdescription, _projectachievement, _projectlink,
    _socialmedia, _certifications,    
    _uid; 
  ...
  void updateWhatsAppNumber(String whatsappnumber) => _whatsappnumber = whatsappnumber;
  ...
  void updateWorkDescription(String workdescription) => _workdescription = workdescription;
  ...
  void updateExpectedStatus(String expectedstatus) => _expectedstatus = expectedstatus;
  void updateExpectedJob(String expectedjob) => _expectedjob = expectedjob;
  void updateExpectedCareer(String expectedcareer) => _expectedcareer = expectedcareer;
  void updateExpectedTown(String expectedtown) => _expectedtown = expectedtown;
  void updateExpectedMoney(String expectedmoney) => _expectedmoney = expectedmoney;
