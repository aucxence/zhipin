...
class SlidingPanel<T> extends PopupRoute<T> {
  final String collection, chosenfield;

  SlidingPanel({Key key, this.chosenfield, this.collection});
    ...
    var c = Container(
        ...
        child: StreamBuilder(
            stream: Firestore.instance
                .collection(widget.route.collection)
                .where("field", isEqualTo: widget.route.chosenfield)
                .snapshots(),
