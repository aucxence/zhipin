...
class StepTwoConf extends StatefulWidget {
  final AppState appstate;

  const StepTwoConf({Key key, this.appstate}) : super(key: key);

  @override
  _StepTwoConfState createState() => _StepTwoConfState();
}
...
class _StepTwoConfState extends State<StepTwoConf> {
  ...
  void initState() {
    ...
    if (widget.appstate.user.company != null) {
      labels = [
        widget.appstate.user.company,
        widget.appstate.user.period1,
        widget.appstate.user.period2,
        widget.appstate.user.poscategory,
        widget.appstate.user.jobtags,
        widget.appstate.user.workdescription,
      ];
    }
