...
class LongFieldWriter extends StatefulWidget {
  final String existing, hinttext, topic, collection;
...
class _LongFieldWriterState extends State<LongFieldWriter> {
  ...
  @override
  void initState() {
    textlength = widget.existing.split(" ").length;
    _textcontroller.text = widget.existing;
    super.initState();
  }
        ...
        actions: <Widget>[
          IconButton(
              icon: Icon(Icons.done,
                  color: (widget.condition(_textcontroller.text))
                      ? Colours.app_main
                      : Colors.black45),
              onPressed: () {
                widget.condition(_textcontroller.text)
                    ? _validersuivant(user)
      ...
      body: Stack(children: <Widget>[
                        ...
                        ? Container(
                            ...
                            child: Card(
                                ...
                                child: FutureBuilder<QuerySnapshot>(
                                    future: appstate.dao.getDocsEqualCriteria(
                                        widget.collection),
        ...
        Positioned(
          ...
          child: GestureDetector(
              ...
              onTap: () => _validersuivant(user)),
        )
      ]),
    );
  }

  _validersuivant(User model) {
    // model.updateAdvantage(_textcontroller.text);
    if (widget.condition(_textcontroller.text)) {
