              ...
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext Context, int index) {
                    return _leftItem(_list[index].name,
                    ...
                    children: <Widget>[
                      _list.length > 0
                          ? GridView.builder(
                              ...
                              shrinkWrap: true,
                              itemCount:
                                  _list[_activeIndex].subLevelModelList.length,
                              itemBuilder: (BuildContext context, int index) {
                                return _rightItem(_list[_activeIndex]
                                    .subLevelModelList[index]
                                    .name);
                              },
                            )
                          : Text("")
    ...
    return GestureDetector(
      child: Container(
        ...
        child: Text(
          ...
          style:
              TextStyle(color: isActive ? Colours.app_main : Color(0Xff747474)),
        ),
