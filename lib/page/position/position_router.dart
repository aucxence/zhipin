...
class PositionRouter implements IRouterProvider {
  ...
  void initRouter(Router router) {
    router.define(positionPage,
        handler: Handler(handlerFunc: (_, params) => PositionPage()));
    router.define(positionAdd,
        handler: Handler(handlerFunc: (_, params) => PositionAdd()));
    router.define(positionSearch,
        handler: Handler(handlerFunc: (_, params) => PositionSearch()));
    router.define(positionFilter,
        handler: Handler(handlerFunc: (_, params) => PositionFilter()));
    router.define(positionCity,
        handler: Handler(handlerFunc: (_, params) => PositionCity()));
    router.define(positionDetail,
        handler: Handler(handlerFunc: (_, params) => PositionDetail()));
  }
}
