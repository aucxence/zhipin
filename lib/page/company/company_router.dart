...
class CompanyRouter implements IRouterProvider {
  ...
  void initRouter(Router router) {
    router.define(companyPage,
        handler: Handler(handlerFunc: (_, params) => CompanyPage()));
    router.define(companyDetail,
        handler: Handler(handlerFunc: (_, params) => CompanyDetail()));
  }
}
