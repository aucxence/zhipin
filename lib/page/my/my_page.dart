...
class _MyPageState extends State<MyPage>
  ...
  void initState() {
    ...
    setState(() {
      _user = {"name": '张三儿', "photo": 'assets/images/avatar.jpg'};
    });
  }
              ...
              child: Column(
                children: <Widget>[
                        ...
                        Container(
                          ...
                          child: GridView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return _itemTop(_userMsg[index]['title'],
                                  _userMsg[index]['sub']);
                            },
                          ),
                        )
                  ...
                  _itemCell(
                      title: '管理求职意向',
                      sub: '在职-暂不考虑',
                      icon: 'icon/ic_share_wechat'),
                  Divider(
                    height: ScreenUtil().setHeight(2.0),
                    color: Color(0xffF9F9F9),
                  ),
                  _itemCell(
                      title: '个人主页', sub: '', icon: 'icon/ic_share_colleague'),
                  Divider(
                    height: ScreenUtil().setHeight(2.0),
                    color: Color(0xffF9F9F9),
                  ),
                  ...
                  _itemCell(
                      title: '提升简历排名', sub: '', icon: 'icon/ic_share_sms'),
                  Divider(
                    height: ScreenUtil().setHeight(2.0),
                    color: Color(0xffF9F9F9),
                  ),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Container(
            child: Center(
              child: loadAssetImage("${img}",
                  fit: BoxFit.cover, width: ScreenUtil().setWidth(100.0)),
            ),
          )
        ],
      ),
          ...
          title: Container(
            child: Row(
              children: <Widget>[
                Container(
                  margin: EdgeInsets.only(
                      right: icon != null ? ScreenUtil().setWidth(20.0) : 0.0),
                  child: icon != null
                      ? loadAssetImage('${icon}',
