...
typedef DegreeValueCallback(String degree, String style);

typedef RangeValueCallback(DateTime dateTime, DateTime dateTime2, List<int> selectedIndex);

typedef SingleValueCallback(String value);
